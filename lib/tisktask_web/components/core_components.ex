defmodule TisktaskWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: TisktaskWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TisktaskWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TisktaskWeb.Gettext, "errors", msg, opts)
    end
  end
