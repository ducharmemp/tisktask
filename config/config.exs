...
config :tisktask, Tisktask.Mailer, adapter: Swoosh.Adapters.Local
...
config :tisktask, TisktaskWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: TisktaskWeb.ErrorHTML, json: TisktaskWeb.ErrorJSON],
    layout: false
  ],
