...
### DaisyUI Guidelines
If you need to do styling, prefer daisyui over vanilla tailwindcss. **Avoid** inline styles or CSS stylesheets. Tailwind and daisyui are the preferred libraries

Refer to https://daisyui.com/llms.txt for usage
...
LiveViews that require login should **always be placed inside the __existing__ `live_session :require_authenticated_user` block**:
    ...
    scope "/", AppWeb do
      ...
      live_session :require_authenticated_user,
        on_mount: [{RahrahWeb.UserAuth, :require_authenticated}] do
...
LiveViews that can work with or without authentication, **always use the __existing__ `:current_user` scope**, ie:
    ...
    scope "/", MyAppWeb do
      ...
      live_session :current_user,
        on_mount: [{RahrahWeb.UserAuth, :mount_current_scope}] do
